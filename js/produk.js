...
async function getAllBarang() {
  ...
  if (kategori) {
    const response = await fetch(
      "http://192.168.1.39:8082/kategori/" + kategori + "/" + page,
      {
        headers: {
          Authorization:
    ...
    const response1 = await fetch(
      "http://192.168.1.39:8082/kategori/" + kategori,
      {
        headers: {
          Authorization:
            "Bearer {2YkUfjkBhSDocbv4p08ATxo02KI_7Bk2fku2L9VJvqYy1RUZ4}",
    ...
    const response = await fetch(
      "http://192.168.1.39:8082/subkategori/" + subkategori + "/" + page,
      {
        headers: {
          Authorization:
            "Bearer {2YkUfjkBhSDocbv4p08ATxo02KI_7Bk2fku2L9VJvqYy1RUZ4}",
    ...
    const response = await fetch(
      "http://192.168.1.39:8082/get20barang/" + page,
      {
        headers: {
          Authorization:
            "Bearer {2YkUfjkBhSDocbv4p08ATxo02KI_7Bk2fku2L9VJvqYy1RUZ4}",
    ...
    const response1 = await fetch("http://192.168.1.39:8082/getallbarang/", {
      headers: {
        Authorization:
          "Bearer {2YkUfjkBhSDocbv4p08ATxo02KI_7Bk2fku2L9VJvqYy1RUZ4}",
      },
...
elmformsearch.addEventListener("submit", (e) => {
  ...
  async function cariProduk() {
    ...
    const response = await fetch("http://192.168.1.39:8082/cari", {
      method: "POST",
      headers: {
